 ...
 * @LastEditTime: 2020-06-10 16:14:44
 */
    ...
    const float location_distance_weight) 
{
  if (location_distance_weight >= 0) {
    ...
    cout << "location distance weight of TrackObjectDistance is "
          << s_location_distance_weight_<<endl;
    return true;
  }
  cout << "invalid location distance weight of TrackeObjectDistance!"<<endl;
  return false;
}
    ...
    const float direction_distance_weight) 
{
  if (direction_distance_weight >= 0) 
  {
    ...
    cout << "direction distance weight of TrackObjectDistance is "
          << s_direction_distance_weight_<<endl;
    return true;
  }
  cout << "invalid direction distance weight of TrackObjectDistance!"<<endl;
  return false;
}
    ...
    const float bbox_size_distance_weight) 
{
  if (bbox_size_distance_weight >= 0) 
  {
    ...
    cout << "bbox size distance weight of TrackObjectDistance is "
          << s_bbox_size_distance_weight_<<endl;
    return true;
  }
  cout << "invalid bbox size distance weight of TrackObjectDistance!"<<endl;
  return false;
}
    ...
    const float point_num_distance_weight) 
{
  if (point_num_distance_weight >= 0) 
  {
    ...
    cout << "point num distance weight of TrackObjectDistance is "
          << s_point_num_distance_weight_<<endl;
    return true;
  }
  cout << "invalid point num distance weight of TrackObjectDistance!"<<endl;
  return false;
}
    ...
    const float histogram_distance_weight) 
{
  if (histogram_distance_weight >= 0) 
  {
    ...
    cout << "histogram distance weight of TrackObjectDistance is "
          << s_histogram_distance_weight_<<endl;
    return true;
  }
  cout << "invalid histogram distance weight of TrackObjectDistance!"<<endl;
  return false;
}
    ...
    const std::shared_ptr<TrackedObject>& new_object) 
{
  ...
  {
    cout << "sizes of compared features not matched. TrackObjectDistance";
    return FLT_MAX;
  }
